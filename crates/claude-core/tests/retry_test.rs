...
fn test_backoff_exponential() {
    ...
    assert!(d1 >= Duration::from_millis(500) && d1 <= Duration::from_millis(625 + 10));
    assert!(d2 >= Duration::from_millis(1000) && d2 <= Duration::from_millis(1250 + 10));
    assert!(d3 >= Duration::from_millis(2000) && d3 <= Duration::from_millis(2500 + 10));
}
