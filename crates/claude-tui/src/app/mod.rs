...
use claude_core::permissions::types::{PermissionMode, ToolPermissionContext};
use claude_core::query::engine::{QueryEngine, TurnResult};
...
pub(crate) struct PendingTool {
    pub(crate) info: claude_core::query::engine::ToolUseInfo,
}
...
pub struct App {
    ...
    pub(crate) app_state: Option<claude_core::state::AppStateStore>,
